...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  useEffect(() => {
    if (["tickets", "plantillas", "base-conocimiento"].includes(activeView)) {
      setTicketsOpen(true);
    }
    if (
      [
  ...
  return (
    <>
      ...
      <aside
        className={`sidebar glass-panel ${mobileOpen ? "mobile-open" : ""}`}
      >
        ...
        <nav className="sidebar-nav">
          {/* USER Sede - Simple Interface (ONLY Tickets & Base de Conocimientos) */}
          {isUserRole ? (
            <>
              <button
              ...
              <button
                className={`nav-item ${activeView === "base-conocimiento" ? "active" : ""}`}
                onClick={() => handleNav("base-conocimiento")}
              >
                <span className="nav-icon">{Icons.kb}</span>
                <span className="nav-label">Base de Conocimientos</span>
                {activeView === "base-conocimiento" && (
                  <div className="active-glow"></div>
                )}
              </button>
            </>
            ...
            <>
              ...
              <div className={`accordion-group ${ticketsOpen ? "open" : ""}`}>
                ...
                >
                  ...
                  <svg className="accordion-arrow" viewBox="0 0 24 24">
              ...
              {(user?.rol === "ADMIN" ||
                ...
                >
                  ...
                  <div className="accordion-content">
                    ...
                    <button
                      className={`sub-nav-item ${activeView === "actas" ? "active" : ""}`}
                      onClick={() => handleNav("actas")}
                    >
                      <span>• Actas</span>
                    </button>
                    <button
        ...
        <div className="sidebar-footer">
          <div className="user-profile">
            ...
            <div className="user-info">
              <div className="username" title={user?.nombre}>
                {user?.nombre}
              </div>
              <div
                className={`user-role-badge role-${user?.rol.toLowerCase()}`}
              >
